...
if (!traceZip || !inputVideo) {
  console.error('Usage: node scripts/video-script-generator/annotate-video-from-trace.mjs <trace.zip> <video.webm> [output.mp4] [--clip-start-ms=<ms>] [--clip-end-ms=<ms>] [--scenario-xml=<path>] [--intermediate-plan=<path>] [--remotion-script=<path>]')
  process.exit(1)
}
...
function buildRemotionTsxScript(plan) {
  ...
  const lines = [
    '// Generated by scripts/video-script-generator/annotate-video-from-trace.mjs',
